...
namespace PointManager.Models
{
    public class MazeGenerator
    {
        ...
        public void MakeMaze(Model3DGroup Model3DGroup_Lights)
        {
            ...
            MeshGeometry3D Base_mg3 = CreateMg3(Model3DGroup_Lights, Base_Material);
            MeshGeometry3D Top_mg3 = CreateMg3(Model3DGroup_Lights, Top_Material);
            MeshGeometry3D Outer_mg3 = CreateMg3(Model3DGroup_Lights, Outer_Material);
            MeshGeometry3D Inner_mg3 = CreateMg3(Model3DGroup_Lights, Inner_Material);
